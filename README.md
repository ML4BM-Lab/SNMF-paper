nohup bash /scratch/lalonsoeste/PhD/NMF_deconvolution/run.sh \
    ...
    --output_path=/scratch/lalonsoeste/PhD/NMF_deconvolution/results/new/synthetic_scDesign3/hungarian \
    --k=20 \
...
nohup bash /scratch/lalonsoeste/PhD/NMF_deconvolution/run.sh \
    ...
    --output_path=/scratch/lalonsoeste/PhD/NMF_deconvolution/results/new/synthetic_starfysh/hungarian \
    --k=5 \
