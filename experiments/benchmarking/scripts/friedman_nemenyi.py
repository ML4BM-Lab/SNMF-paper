...
BENCHMARK_DATASETS = ["TNBC", "PDAC", "HLC"]
...
def parse_args():
    ...
    parser.add_argument(
        "benchmarking_path",
        type=Path,
        help="Path to the benchmarking outputs folder, e.g. experiments/benchmarking/outputs.",
    )
    parser.add_argument(
        "--alpha",
        type=float,
        ...
        rows.append(
            {
                ...
                "Value": row["Value"],
                "Direction": "max",
                "Source": "outputs/DLPFC/ari_table.tex:Mean",
            }
        )
    ...
    manifest = pd.DataFrame(
        [
            ...
            },
            {
                ...
                "Description": (
                    "Single rank-based Friedman-Nemenyi test over TNBC/PDAC/HLC "
