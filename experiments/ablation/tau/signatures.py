...
DEFAULT_RESULTS_PATH = REPO_ROOT / "experiments" / "ablation" / "tau" / "outputs"
DEFAULT_MARKER_PATHS = {
    "TNBC": REPO_ROOT / "data" / "TNBC" / "TNBC_marker_genes.csv",
    "PDAC": REPO_ROOT / "data" / "PDAC" / "PDAC_marker_genes.csv",
    "HLC": REPO_ROOT / "data" / "HLC" / "HLC_marker_genes.csv",
}
DEFAULT_FULL_MARKER_PATHS = {
    "PDAC": REPO_ROOT / "data" / "PDAC" / "PDAC_marker_genes_full.csv",
    "HLC": REPO_ROOT / "data" / "HLC" / "HLC_marker_genes_full.csv",
}
...
def parse_args():
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "or both. Full mode is configured for PDAC and HLC. Default: plain"
        ),
    )
    parser.add_argument(
        "--marker-p-adj",
