...
load(file.path(data_dir, "spatial_count.RData"))
load(file.path(data_dir, "spatial_location.RData"))
...
write.csv(proportion_mat, file.path(zenodo_dir, "PDAC_proportions.csv"), row.names=T)
...
write.csv(spatial_new_mixture, file.path(zenodo_dir, "PDAC_counts.csv"), row.names=T)
