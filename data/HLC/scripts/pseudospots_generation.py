...
ZENODO_DIR = REPO_ROOT / "data" / "HLC" / "final"

SDATA_PATH = DATA_DIR / "sdata_lung_s1.zarr"
...
OUT_H5AD = DERIVED_DIR / "pseudospots.h5ad"
OUT_PROPS = OUT_DIR / "HLC_proportions.csv"
OUT_MARKER_GENES = OUT_DIR / "HLC_marker_genes.csv"
...
adata_spots.to_df().transpose().to_csv(OUT_DIR / "HLC_pseudospots.csv")
spot_props.to_csv(OUT_PROPS)
markers_df.to_csv(OUT_MARKER_GENES)

sc.pl.spatial(adata_spots, color=spot_props.columns, spot_size=SPOT_DIAMETER_UM, show=False)[0].figure.savefig(DERIVED_DIR / "spatial_proportions.png")
